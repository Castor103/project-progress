...
* ![](https://progress-bar.dev/90/?title=Progress) <br/>
    90 ~ 99% FSW연동 없이 zmq 소켓을 통한 확인 완료 혹은 기능 개발은 완료 했지만 테스트가 남았거나 확인이 더 필요한 상황. 
    <br/>
...
* *"(자체 확인)"* <br/>
    FSW 연동 없이 STB <-> Zmq 소켓 통신을 통한 테스트를 통한 기능 확인  <br/>
...
버스의 각 로직 모듈들을 모사해주는 subsystem data simulator와 이들을 연결해주는 satellite data Simlation core로 이루어짐.
 ...
 - ## 1.1. Satellite Data Model / Core
    ...
    * 필요한 기능은 완료.
    * 전체적으로 *전류 연동 및 온도 연동 기능은 지속적인 디버깅 필요*
